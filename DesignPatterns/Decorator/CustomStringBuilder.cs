...
{
    /// <summary>
    /// A customized string builder which decorates the StringBuilder class.
    /// In this case, the StringBuilder class is sealed and will not allow for inheritance.
    /// </summary>
    public class CustomStringBuilder
    {
        ...
        public unsafe CustomStringBuilder Append(char* value, int valueCount)
        {
